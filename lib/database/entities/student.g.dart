...
extension StudentByIndex on IsarCollection<Student> {
  Future<Student?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Student? getByNameSync(String name) {
  ...
  Future<List<Student?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Student?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Student object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Student object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Student> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Student> objects, {bool saveLinks = true}) {
