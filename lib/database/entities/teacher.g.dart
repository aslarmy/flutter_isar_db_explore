...
extension TeacherByIndex on IsarCollection<Teacher> {
  Future<Teacher?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  Teacher? getByNameSync(String name) {
  ...
  Future<List<Teacher?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Teacher?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Teacher object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Teacher object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Teacher> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Teacher> objects, {bool saveLinks = true}) {
